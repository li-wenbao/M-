...
/* 4 */
/*!*********************************************!*\
  !*** F:/project/gitProject/M云音乐/pages.json ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 7 */
/*!**************************************************************!*\
  !*** F:/project/gitProject/M云音乐/pages.json?{"type":"style"} ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": {}, "pages/search/search": {}, "pages/play/play": {} }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "Music", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),
/* 8 */
/*!*************************************************************!*\
  !*** F:/project/gitProject/M云音乐/pages.json?{"type":"stat"} ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "wx031aa701d76ab64f" };exports.default = _default;
...
/* 15 */
/*!*************************************************!*\
  !*** F:/project/gitProject/M云音乐/store/store.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: {
    ...
    initMusicList: function initMusicList(state, list) {
    ...
    initMusic: function initMusic(state, list) {
      state.muisc = list;
    },
    initMusicFace: function initMusicFace(state, list) {
      state.muiscface = list;
    } },

  actions: {
    getMusicList: function getMusicList(context, val) {
      // Promise
      uni.request({
      ...
      then(function (data) {var _data = _slicedToArray(
        ...
        song.map(function (item) {
          ...
          var arrItem = item.artists;
          img1v1Url = arrItem.map(function (sitem) {
            sitem.img1v1Url;
          });
        });
        context.commit("initMusicList", { song: song, img1v1Url: img1v1Url });
      });

    },
    getMusic: function getMusic(context, val) {
      uni.request({
      ...
      then(function (data) {var _data2 = _slicedToArray(
        ...
        var muisc = res.data.data[0].url;
        console.log("播放歌曲222", muisc);
        context.commit("initMusic", muisc);
      });
    },
    musicFace: function musicFace(context, val) {
      uni.request({
      ...
      then(function (data) {var _data3 = _slicedToArray(
        ...
        var muiscface = res.data.songs[0].al.picUrl;
        // console.log("播放歌曲222",muisc);
